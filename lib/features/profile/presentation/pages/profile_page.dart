...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Mock user data - will be replaced with actual user data from Firebase
    final userName = user?.email?.split('@').first ?? 'Benjamin Jack';
    final userEmail = user?.email ?? 'benjaminJack@gmail.com';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _buildProfileHeader(context, ref, userName, userEmail),
  ...
  Widget _buildProfileHeader(BuildContext context, WidgetRef ref, String userName, String userEmail) {
    final authState = ref.watch(authControllerProvider);
